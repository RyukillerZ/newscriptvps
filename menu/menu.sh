...
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e   ""
echo -e "${BICyan}$NC ${BICyan}Today${NC}: ${red}$ttoday$NC ${BICyan}Yesterday${NC}: ${red}$tyest$NC ${BICyan}Monthly${NC}: ${red}$tmon$NC $NC"
echo -e   ""
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e "\e[1;34m                   TOTAL CONFIG                   \e[0m"
echo -e "\e[1;33m -------------------------------------------------\e[0m"
echo -e   ""
echo -e " \e[1;31m       Vmess         Vless          Trojan       \e[0m "
echo -e " \e[1;91m       $vless        $vless          $trws       \e[0m "
echo -e   ""
echo -e "\e[1;33m -------------------------------------------------\e[0m"
